...
void main() {
    ...
    keys[0] = vec3(122.0,164.0,230.0)/255.0;
    keys[1] = vec3(88.0,128.0,200.0)/255.0;
    keys[2] = vec3(65.0,147.0,106.0)/255.0;
    keys[3] = vec3(65.0,164.0,114.0)/255.0;
    keys[4] = vec3(81.0,106.0,155.0)/255.0;
