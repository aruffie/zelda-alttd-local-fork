...
function enemy:start_walking()
  ...
  enemy:start_straight_walking(walking_possible_angles[math.random(8)], walking_speed, math.random(walking_minimum_distance, walking_maximum_distance), function()
    enemy:start_walking()
  end)
end
